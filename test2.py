...
class Spider():
	...
	def blazers(self):
		...
		etree_alt_data = []
		etree_src_data = []
		etree_alt = etree_alt_data.append(etree_data.xpath('//div[@class="am-gallery-item"]/a/img/@alt'))
		etree_src = etree_src_data.append((etree_data.xpath('//div[@class="am-gallery-item"]/a/@href')))
